set terminal latex
set output 'line_example_with_values.tex'
...
set label "($x_{11}=2, y_1=5$)"  at first  0.5, first 6.5
set label "($x_{21}=6, y_2=13$)"  at first  4.5, first 14.5
set label "($x_{u1}=x_u, y_u=?$)"  at first  2.5, first 10.5
